...
Im [ersteren Anwendungsbeispiel](#medizinische-beratung-über-alexa-mittels-gyant-skill) wird die Abfrage von verifizierten Gesundheitsinformationen über eine Voice-App (Skill) von GYANT untersucht. Dabei wird beschrieben, wie Menschen mithilfe eines Sprachassistenten eine Krankheit und deren Schweregrad durch vorhandene Symptome herausfinden können. Im [letzteren Anwendungsbeispiel](#eine-eigenständige-triage-diagnose-stellen-über-alexa-mittels-«health-navigator»-skill) wird ein durch die Zusammenarbeit von Health Navigator und des Softwareentwicklungsunternehmens Macadamian entstandener Proof-of-Concept beschrieben. Die Voice-App erlaubt Menschen jederzeit und überall Gesundheitsinformationen und Ratschläge einzuholen, dabei liegt der Schwerpunkt auf der Diagnose nach dem Schweregrad der Krankheit, welche durch die von Health Navigator entwickelten Triage-Engine ermöglicht wird.

Pro Anwendungsbeispiel wird anhand je einer konkreten User-Journey aufgezeigt, wie der Mensch mittels Fragen durch die Voice-App geführt wird und wie ein mögliches Diagnosegespräch per Sprachassistenten abläuft. Dabei wird behandelt, wie Menschen mithilfe von Sprachassistenten selbstständig eine Triage-Diagnose stellen und/oder eine Krankheit mittels Symptome erkennen können. Sobald durch die Voice-App eine Notfallsituation erkennt wird, gibt diese je nach verwendeter Voice-App eine zusätzliche Empfehlung ein Arzt, eine Ärztin oder ein Spital aufzusuchen aus.
...
Gemäss aus einer Umfrage aus dem durch Voicebot.ai und Orbit veröffentlichtem Report ist bereits ersichtlich, das ca. 7,5&nbsp;Prozent aller Konsumenten oder Konsumentinnen innerhalb den Vereinigten Staaten von Amerika mindestens einmal einen Sprachassistenten für eine Anfrage im Zusammenhang mit dem Gesundheitswesen gebraucht zu haben. Auch wenn 7,5&nbsp;Prozent klein scheint, sind das ca. 19&nbsp;Millionen Personen. Der Bedarf ist bereits in einigen Situationen sehr gross: fast 73&nbsp;Prozent aller Befragten gaben an, den Sprachassistenten mindestens einmal verwendet haben, um nach ihren Krankheitssymptomen zu fragen (Kinsella, 2019: 11, 12).[^:lit:voicebot]
...
Das erste Ziel «Daten gewinnen» kann sich mittels der Beobachtung durch Ärzte überprüfen lassen, welche dann durch die gewonnen Daten in der Lage sind, eine mehr oder weniger vollständige Vorgeschichte einer Krankheit zu erheben. Genauso gilt selbiges auch für das dritte Ziel, welches gestützt auf das erste Ziel und durch ein konkretes Verhalten der Ärzte überprüfen lässt, wann immer Patienten oder Patientinnen direkt oder indirekt über seine Gefühle sprechen (SAMW, 2013: 11).[^:lit:samw]

Es wird jedoch schnell ersichtlich, dass selbst einfach scheinende Ziele sich als komplexe Aufgaben herausstellen können. Ist es zum Beispiel als Ziel vorgesehen, dass ein/eine PatientIn nach der Konsultation mehr weiss als vorher, braucht es am Ende einer Informationsvermittlung eine weitere Überprüfung durch einen Arzt oder eine Ärztin, um herauszufinden was der/die PatientIn verstanden hat. Das gleiche Prinzip gilt auch für das zweite Ziel «PatientIn informieren» bzw. die eigentliche Vermittlungsphase. Information kann erst dann als erfolgreich übermittelt angesehen werden, wenn die Übermittlung als rekursiver Prozess (vermitteln, Reaktion abwarten, vermitteln, Reaktion abwarten) verstanden wird (SAMW, 2013: 12).[^:lit:samw]
...
GYANT als Alexa Skill hilft PatientInnen eine Triage-Diagnose zu stellen und die Krankheit zu erkennen, welche die Symptome verursacht. Anhand eines Dialogs mit dem Sprachassistenten werden die Symptome der NutzerIn analysiert und weiterverarbeitet. In einem weiteren Schritt gibt der Skill eine Diagnose ab, in dieser ist für den/die Nutzer/-in der Schweregrad der Krankheit plus eine Empfehlung ersichtlich, so wie die Bezeichnung der Krankheit erkennbar (Ellen Foley K. und Zhou Y., 2018).[^:qu:qz]

NutzerInnen können sich auf die durch GYANT ausgegeben Informationen verlassen. Produkte von GYANT sind klinisch verifiziert,  besonders im Bereich der Triage-Diagnose wurde eine umfassende Studie durchgeführt, um die Genauigkeit zu garantieren (MEDCITY NEWS, 2019).[^:qu:medcity]

Gemäss dem Ministerium für Gesundheit und soziale Fürsorge in England helfen sprachbasierte Anwendungen durch die dynamische und vereinfachte Bedienung mittels Sprache hauptsächlich Patienten und Patientinnen, welche auf klassischem Weg das Internet nicht nutzen können, insbesondere älteren und blinden Personen (Department of Health and Social Care, 2019).[^:qu:dhsc]
...
Der Skill wird angetrieben von einer durch GYANT entwickelten Künstlicher Intelligenz. Starten NutzerInnen den Skill über Alexa z.&#x202F;B.&nbsp;mit dem Sprachbefehl: «Alexa, bitte GYANT meine Symptome zu prüfen.» oder «Alexa, starte GYANT.», beginnt GYANT über einen Dialog Daten zu sammeln, um eine ausführliche Vorgeschichte der Krankheit abzubilden, dabei werden mehrere Fragen an den/die Nutzer/-in gestellt (Amazon GYANT, 2019).[^:qu:agyant]

Sobald GYANT alle benötigten Informationen durch den/die Nutzer/-in erhalten hat, werden diese durch die eigens entwickelte Künstliche Intelligenz analysiert und mit der eigenen Datenbank abgeglichen. Der Skill informiert nun den/die Nutzer/-in über die mögliche Krankheit, dabei wird je nach Einschätzung der Symptome eine Empfehlung abgegeben. Sofern nötig werden die NutzerInnen aufgefordert, möglichst schnell einen Termin beim Arzt, bei einer Ärztin oder einer Notfallpraxis zu vereinbaren (Ellen Foley K. und Zhou Y., 2018).[^:qu:qz]

### Anwendungsbeispiel (User Journey)

Möchten NutzerInnen über den klassischen Weg einen Abruf über ein Computer oder ein Smartphone starten, wieso zum Beispiel sein rechter Unterbauch schmerzt, ist die erste Anlaufstelle sehr wahrscheinlich Dr. Google oder ein bereits bekanntes Gesundheitsforum. Dabei ist dieses Vorgehen vergleichbar mit einer Suche nach der Nadel im Heuhaufen. Hunderte Webseiten geben vor, die korrekte Antwort zu haben. Doch welche hat nun die richtige Antwort und welche davon ist wirklich vertrauenswürdig? Der/die NutzerIn wird regelrecht mit einer Auswahl an Webseiten überflutet. 

Nehmen NutzerInnen nun die Hilfe eines Sprachassistenten dazu und sagen zum Beispiel: «Alexa, was ist der Schmerz in meinem rechten Unterbauch?», so wird die entsprechende Absicht bzw. die Ursache des Schmerzes im rechten Unterbauch herauszufinden, direkt durch Alexa erkannt, analysiert und weiterverarbeitet. Alexa selbst wird jedoch diese Frage ohne weitere Hilfe noch nicht exakt beantworten können oder würde mit grosser Wahrscheinlichkeit einfach auf Google, Wikipedia oder relevante Webseiten zurückgreifen. Für eine verifizierte Antwort braucht es zuerst erweitertes Wissen von DrittanbieterInnen. Hier kommt der Skill von GYANT ins Spiel. Dafür müssen NutzerInnen die Anfrage an Alexa umformulieren, damit Alexa mit GYANT spricht: «Alexa, frage GYANT was der Schmerz in meinem rechten Unterbauch ist?». Alexa verbindet sich nun über den vorhandene Skill und leitet die Anfrage an die entsprechenden Rechenzentren von GYANT weiter. Der Skill beginnt mit dem/der Nutzer/-in zu sprechen und startet mit der Analyse der Symptome.
...
Durch die Hilfe der Triage-Engine von Health Navigator werden NutzerInnen beim starten des Skills durch mehrere Fragen zu Alter, Geschlecht, Symptome und Fragen zu wichtigen Faktoren geleitet, um so eine ausführliche Vorgeschichte der Krankheit abzubilden. Health Navigator gibt dann je nach Einschätzung und Schweregrad der Symptome eine Empfehlung ab. Beispielsweise können NutzerInnen Optionen zur Selbstversorgung erhalten oder werden aufgefordert, möglichst schnell einen Termin beim Arzt, bei einer Ärztin oder einer Notfallpraxis zu vereinbaren. Durch die Hilfe von Macadamian und deren Fachwissen im Bereich User Experience und Sprachassistenten konnte ein neuer Skill bzw. Proof-of-Concept erschaffen werden, welcher über die vorhandene Anwendungsschnittstelle (API) auf die riesigen Datenbanken von Health Navigator zugreift. Diese wurden mit mehr als fast zwei Jahrzehnten langer Expertenarbeit, Literaturrecherchen, Data Mining, Analyse sowie Tests durch Health Navigator sorgfältig erarbeitet (Tabor, 8. August 2018).[^:qu:tabor]

### Anwendungsbeispiel (User Journey)

Aus dem Demonstrationsvideo von Health Navigator ist folgender Dialog ersichtlich, welcher zwischen dem Patienten Mike und Alexa entstand. Sobald Alexa durch Mike aufgefordert wird die «Health Navigator»-Skill zu starten  (Health Navigator, 2018):[^:qu:hn]

*Da der Health Navigator Skill nur englischsprachig verfügbar ist, ist die Niederschrift des geführten Gesprächs nur auf Englisch verfügbar.*
...
![Mike startet den Alexa Skill.](./img/hn-1.svg)
*Schwarzer Amazon Echo Dot Lautsprecher.[^:abb:one]*

</Grid>

Mike leidet an erbrechen und einem entzündetem Hals, diese Symptome teilt er im ersten Schritt mit dem Skill über Alexa mit. 

<Grid>

![Mike leidet an erbrechen und einem entzündetem Hals, diese Symptome teilt er im ersten Schritt mit dem Skill über Alexa mit.](./img/hn-2.svg)
*Schwarzer Amazon Echo Dot Lautsprecher.[^:abb:one]*

</Grid>

Der Skill versucht nun herauszufinden, welche Symptome den/die NutzerIn am meisten plagen. Der Fokus wird durch Mike selbst auf das Erbrechen gelegt und der Skill versucht nun mittels mehreren Fragen zusätzliche Informationen über dieses Symptom zu sammeln.

<Grid>

![Der Skill versucht nun herauszufinden, welche Symptome den/die NutzerIn am meisten plagen. Der Fokus wird durch Mike selbst auf das Erbrechen gelegt und der Skill versucht nun mittels mehreren Fragen zusätzliche Informationen über dieses Symptom zu sammeln.](./img/hn-3.svg)
*Schwarzer Amazon Echo Dot Lautsprecher.[^:abb:one]*
...
![Der Skill springt nach einigen Fragen wieder zurück zum Anfang und setzt den Fokus kurz anders. So werden neben dem Symptom Erbrechen zusätzliche Informationen über die Halsentzündung gesammelt. ](./img/hn-4.svg)
*Schwarzer Amazon Echo Dot Lautsprecher.[^:abb:one]*

</Grid>

Es wird nun versucht über wichtige allgemeine Fragen die Krankheit und der mögliche Schweregrad einzugrenzen. Dabei wird durch Alexa mögliche weitere Symptome aufgezählt und je nachdem wie Mike antwortet, hilft dies dem Skill  mögliche Krankheiten auszusortieren.

<Grid>

![Es wird nun versucht über wichtige allgemeine Fragen die Krankheit und der mögliche Schweregrad einzugrenzen. Dabei wird durch Alexa mögliche weitere Symptome aufgezählt und je nachdem wie Mike antwortet, hilft dies dem Skill  mögliche Krankheiten auszusortieren.](./img/hn-5.svg)
*Schwarzer Amazon Echo Dot Lautsprecher.[^:abb:one]*

</Grid>

Die Diagnose wird abgeschlossen und der Skill übermittelt eine Triage-Diagnose an Mike. Durch die Beantwortung aller Fragen durch Mike wird festgestellt, dass es sich um einen Notfall handeln könnte. Da Menschen mit ähnlichen Symptomen normalerweise sofortige Massnahmen ergreifen müssen, bittet der Skill Mike sofort ins nächste Krankenhaus zu gehen oder einen Arzt oder eine Ärztin aufzusuchen.

<Grid>

![Die Diagnose wird abgeschlossen und der Skill übermittelt eine Triage-Diagnose an Mike. Durch die Beantwortung aller Fragen durch Mike wird festgestellt, dass es sich um einen Notfall handeln könnte. Da Menschen mit ähnlichen Symptomen normalerweise sofortige Massnahmen ergreifen müssen, bittet der Skill Mike sofort ins nächste Krankenhaus zu gehen oder einen Arzt oder eine Ärztin aufzusuchen.](./img/hn-6.svg)
*Schwarzer Amazon Echo Dot Lautsprecher.[^:abb:one]*
...
Verglichen mit dem Modell von Bird und Cohen-Cole liegt der Fokus vor allem auf dem ersten Ziel, der Datengewinnung um so eine ausführliche Vorgeschichte der Krankheit zu erheben. Wie bereits im ersten Anwendungsbeispiel erwähnt, entfällt auch hier durch den Einsatz von Sprachassistenten die im Normalfall benötigte Konsultation in der Praxis für ein persönliches Arztgespräch. Es findet eine Verschiebung der Abhängigkeit durch Öffnungszeiten einer Praxis zu einer dynamischen Allzeit-Bereitschaft statt, es kann nun mittels Sprache jederzeit eine Anfrage an den Sprachassistenten gesendet werden, unabhängig von Ort und Uhrzeit. Die Ziele zwei «Patienten informieren» und drei «auf die Gefühle von Patienten und Patientinnen eingehen», rücken in den Hintergrund und verursachen eine Minimierung von Berührungspunkten zwischen Arzt/Ärztin und PatientIn, somit wird eine dynamische Effizienz geschaffen, indem die Dauer einer Diagnose signifikant verkürzt wird. Dies lässt sich gut anhand der Dauer von Start bis hin zur Diagnose im Anwendungsbeispiels erkennen.
